...
class Application(object):
    ...
    def lite6_python_welding(self):
        os.system(
            "python ~/catkin_ws/src/xarm_ros/lite6_moveit_config/scripts/lite6_welding.py"
        )
    ...
    def lite6_rviz_moveit_fija(self):
        os.system(
            "roslaunch ~/catkin_ws/src/xarm_ros/lite6_moveit_config/launch/demo_welding.launch"
        )
    def lite6_rviz_moveit_puntos(self):
        os.system(
            "roslaunch ~/catkin_ws/src/xarm_ros/lite6_moveit_config/launch/demo_welding_spot.launch"
        )
    def lite6_rviz_moveit_laser(self):
        os.system(
            "roslaunch ~/catkin_ws/src/xarm_ros/lite6_moveit_config/launch/demo_welding_laser.launch"
        )
    def lite6_rviz_moveit_mig(self):
        os.system(
            "roslaunch ~/catkin_ws/src/xarm_ros/lite6_moveit_config/launch/demo_welding_mig.launch"
        )
    def lite6_rviz_moveit_objeto(self):
        os.system(
            "roslaunch ~/catkin_ws/src/xarm_ros/lite6_moveit_config/launch/demo_welding_objeto.launch"
        )
